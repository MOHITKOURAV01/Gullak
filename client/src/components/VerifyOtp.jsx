        ...
        <div className="pt-32 pb-20 min-h-screen bg-background flex items-center justify-center px-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400 text-sm">Enter the OTP sent to your email and set a new strong password.</p>
                </div>

                <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2 ml-1">Email Confirmation</label>
                        <input
                            type="email"
                            required
                            value={email}
                    ...
                    <div>
                        <label className="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2 ml-1">6-Digit OTP</label>
                        <input
                            type="text"
                            required
                            maxLength={6}
                            ...
                            className="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-center text-2xl font-black tracking-[0.5em] text-primary focus:outline-none focus:border-primary/50 transition-all"
                            placeholder="000000"
                        />
                    </div>
